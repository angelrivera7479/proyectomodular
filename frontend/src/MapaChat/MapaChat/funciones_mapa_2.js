document.addEventListener('DOMContentLoaded', function () {
  // Inicializar ventanas de estado
  Baja();
  BajaSur();
  Yucatan();
  Jalisco();
...
xhr.send();
  ...
  function Baja(){
    ...
    nuevaVentana.innerHTML = `
      <span class="cerrar" onclick="cerrarVentana(this)" ontouchstart="cerrarVentana(this)">&times;</span>
